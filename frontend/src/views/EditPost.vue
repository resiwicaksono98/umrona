<template>
  <div class="m-8">
    <div class="text-xl font-semibold mb-8">Edit Post</div>
    <form @submit.prevent="submit">
      ...
      <button type="submit" class="bg-blue-500 py-2 px-4 rounded-lg text-white">Update Post</button>
    </form>
  </div>
</template>
...
function submit() {
  axios.put(`http://localhost:8000/api/posts/${params.slug}`,form)
  .then(() => {
